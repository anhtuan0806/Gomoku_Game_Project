...
\begin{itemize}
    ...
    \begin{itemize}
        \item Sử dụng tệp \texttt{config.ini} dạng nhị phân để lưu trữ tùy chỉnh âm lượng, ngôn ngữ, trạng thái bật/tắt nhạc nền. Cơ chế này giúp trò chơi "ghi nhớ" được trạng thái của người chơi qua các lần khởi động khác nhau.
    \end{itemize}
    ...
    \begin{itemize}
        \item Nhận \texttt{dt} từ vòng lặp chính để cập nhật bộ đếm thời gian theo lượt; phần đo FPS/độ trễ khung hình được ghi nhận ở \texttt{main.cpp}.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \texttt{GameConfig.h}: lưu cấu hình âm thanh và ngôn ngữ để các phân hệ khác đọc thống nhất.
    ...
    \begin{itemize}
        ...
        \item \texttt{PlayerEngineer}: khởi tạo và reset thông tin người chơi trước mỗi trận/round.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \texttt{TimeSystem}: cung cấp bộ đếm thời gian theo lượt; đo độ trễ khung hình do vòng lặp chính ghi nhận.
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Struct được thiết kế theo hướng dữ liệu, kết hợp trường nguyên thủy và container chuẩn (\texttt{std::vector}, \texttt{std::wstring}) để phục vụ hiển thị và xử lý.
    ...
    Dữ liệu trận đấu được lưu dưới dạng nhị phân thông qua \texttt{SaveLoadSystem}, đảm bảo tốc độ đọc/ghi cao và khôi phục đúng trạng thái. Cấu hình người dùng được lưu trong \texttt{config.ini} dạng nhị phân để đảm bảo tính nhất quán dữ liệu.
\end{itemize}
