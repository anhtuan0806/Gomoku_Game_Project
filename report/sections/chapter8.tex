...
\setlength{\parindent}{1.5em} Việc tuần tự hóa \texttt{PlayerInfo2} tách rõ phần "dữ liệu nhận diện" (name, avatar, piece) và phần "thống kê" (wins, moves, time). Nhờ đó, khi bổ sung trường mới ở phiên bản sau, hệ thống vẫn có thể gán giá trị mặc định trong quá trình đọc để tránh rác bộ nhớ. Các vector động được ghi bằng \texttt{WriteVec} với độ dài trước, giúp phục hồi chính xác số phần tử và tránh đọc sai biên.
