...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Thời gian phản hồi của máy ở cấp độ khó nhất không được vượt quá 2 giây cho mỗi nước đi nhằm duy trì nhịp độ trận đấu.
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textit{Bộ biên dịch:} Tối ưu hóa cho kiến trúc 64-bit nhằm khai thác tối đa sức mạnh của các bộ vi xử lý hiện đại.
